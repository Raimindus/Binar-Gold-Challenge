    ...
    <div className={style.halaman}>
      <div className={`wrapper ${style.wrapper1}`}>
        ...
        <div className={`wrapper ${style.bg}`}>
          <div className={style.wrappertext1}>
            ...
            <Button1 className={style.button1} variant="success">
              Mulai Sewa Mobil
            </Button1>
          </div>
      ...
      <section id="services">
        <div className={`wrapper ${style.servicewrap}`}>
          <div className={`wrapper ${style.girl1}`}>
            <img src={Girl1} alt="girl1" width={300}></img>
          </div>
          <div className={style.servicetext}>
            <p className={style.servicetext1}>
              Best Car Rental for any kind of trip in (Lokasimu)!
            </p>
            <p className={style.servicetext2}>
      ...
      <section id="testimonial">
        ...
        <div className={style.added}>
          ...
          <p class={style.addtext2}>
            {" "}
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
          <div className={style.buttonwrap}>
            <Button1 className={style.addedbutton}>Mulai Sewa Mobil</Button1>
          </div>
        </div>
      </section>
